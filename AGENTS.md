...
src/
  ...
  controllers/        SiteController (sitio público) + ProductController, CategoryController, DashboardController, AuthController, SettingsController, PosController, ClientController, EmployeeController (+ require their model)
